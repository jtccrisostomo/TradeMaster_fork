...
agent = dict(
    ...
    memory_capacity=500,  # tuned
    gamma=0.969522982710727,  # tuned
    policy_update_frequency=300,  # tuned
)
...
trainer = dict(
    ...
    if_remove=False,
    batch_size=96,  # tuned
    horizon_len=256,  # tuned
    buffer_size=1500,  # raised to avoid early sampling underflow with horizon_len=256
)

loss = dict(type="MSELoss")
optimizer = dict(type="Adam", lr=5.1809895833717616e-05)  # tuned
